...
-type pool(MEA, MEB) :: {pool,
        fun((glisten@internal@handler:loop_message(MEA), MEB, glisten@internal@handler:connection(MEA)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(MEA), MEB)),
        integer(),
        fun((glisten@internal@handler:connection(MEA)) -> {MEB,
            gleam@option:option(gleam@erlang@process:selector(MEA))}),
        gleam@option:option(fun((MEB) -> nil)),
        glisten@transport:transport()}.
