...
-spec add_date_header(gleam@http@response:response(OUL)) -> gleam@http@response:response(OUL).
...
-spec connection_close(gleam@http@response:response(OUO)) -> gleam@http@response:response(OUO).
...
-spec keep_alive(gleam@http@response:response(OUR)) -> gleam@http@response:response(OUR).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-spec maybe_keep_alive(gleam@http@response:response(OUU)) -> gleam@http@response:response(OUU).
...
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(OUX)) -> gleam@http@response:response(OUX)).
